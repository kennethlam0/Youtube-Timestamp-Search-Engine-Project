...
def tfc(bigN, invertIndex) :
    ...
    for page in tfIdf :
         #setting the sum of the squares of the weights to 0
         squareRootSum = 0
         ...
         for token in tfIdf[page]:
            ...
            #taking the square root of the sum of the squares of the weights 
...
#function that writes the page to the file
def page(videoText) :
...
def VSM() :
  ...
  #creating bigN to be the length of the vectors
   bigN = len(vectors)   
